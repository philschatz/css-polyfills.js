// This file is adapted from https://github.com/less/less.js/blob/723cdb501e2ab6b5cd64df7036b0cf5eb7de0055/lib/less/browser.js
...
var typePattern = /^text\/(x-)?css-polyfills$/;
var cache = null;
var fileCache = {};
var varsPre = "";
...
for (var i = 0; i < links.length; i++) {
    if (links[i].rel === 'stylesheet/css-polyfills' || (links[i].rel.match(/stylesheet/) &&
